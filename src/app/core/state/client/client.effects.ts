...
import { AlertService, ClientService } from "@core/services";
import { Actions, createEffect, ofType } from "@ngrx/effects";
import { of } from "rxjs";
import { catchError, map, switchMap } from "rxjs/operators";
import * as ModelActions from "./client.actions";
...
export class ClientEffects {
	...
	loadAll$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.ClientActionTypes.appComponentInitialized,
				ModelActions.ClientActionTypes.COLLECTION_LOAD_CLIENTS
			),
	...
	addData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.ClientActionTypes.MODEL_CreateInitiated
			),
			switchMap((action) =>
	...
	editData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.ClientActionTypes.MODEL_UpdateInitiated
			),
			switchMap((action) =>
	...
	editStatus$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.ClientActionTypes.MODEL_UpdateStatusInitiated
			),
			switchMap((action) =>
	...
	restoreData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.ClientActionTypes.MODEL_RestoreInitiated
			),
			switchMap((action) =>
	...
	deleteData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.ClientActionTypes.MODEL_DeleteInitiated
			),
			switchMap((action) =>
	...
	readonly showErrorAlert$ = createEffect(
		() => {
			return this.actions$.pipe(
				ofType(
					ModelActions.ClientActionTypes.MODEL_RestoreFailed,
					ModelActions.ClientActionTypes.MODEL_UpdateSuccess,
					ModelActions.ClientActionTypes.MODEL_UpdateStatusFailed,
					ModelActions.ClientActionTypes.MODEL_CreateFailed,
					//ModelActions.ClientActionTypes.COLLECTION_LOADED_FAILED,
					ModelActions.ClientActionTypes.MODEL_DeleteFailed
				),
				tap(
	...
	readonly showSuccessAlert$ = createEffect(
		() => {
			return this.actions$.pipe(
				ofType(
					ModelActions.ClientActionTypes.MODEL_RestoreSuccess,
					ModelActions.ClientActionTypes.MODEL_UpdateSuccess,
					ModelActions.ClientActionTypes.MODEL_UpdateStatusSuccess,
					ModelActions.ClientActionTypes.MODEL_CreateSuccess,
					ModelActions.ClientActionTypes.COLLECTION_LOADED_SUCCESS,
					ModelActions.ClientActionTypes.MODEL_DeleteSuccess
				),
				tap(
