...
import { AlertService, CreativeService } from "@core/services";
import { Actions, createEffect, ofType } from "@ngrx/effects";
import { of } from "rxjs";
import { catchError, map, switchMap } from "rxjs/operators";
import * as ModelActions from "./creative.actions";
...
export class CreativeEffects {
	constructor(
		...
		private apiService: CreativeService,
	...
	loadAll$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.CreativeActionTypes.appComponentInitialized,
				ModelActions.CreativeActionTypes.COLLECTION_LOAD_CREATIVES
			),
	...
	addData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.CreativeActionTypes.MODEL_CreateInitiated
			),
			switchMap((action) =>
	...
	editData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.CreativeActionTypes.MODEL_UpdateInitiated
			),
			switchMap((action) =>
	...
	editStatus$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.CreativeActionTypes.MODEL_UpdateStatusInitiated
			),
			switchMap((action) =>
	...
	restoreData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.CreativeActionTypes.MODEL_RestoreInitiated
			),
			switchMap((action) =>
	...
	deleteData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.CreativeActionTypes.MODEL_DeleteInitiated
			),
			switchMap((action) =>
	...
	readonly showErrorAlert$ = createEffect(
		() => {
			return this.actions$.pipe(
				ofType(
					ModelActions.CreativeActionTypes.MODEL_RestoreFailed,
					ModelActions.CreativeActionTypes.MODEL_UpdateSuccess,
					ModelActions.CreativeActionTypes.MODEL_UpdateStatusFailed,
					ModelActions.CreativeActionTypes.MODEL_CreateFailed,
					//ModelActions.CreativeActionTypes.COLLECTION_LOADED_FAILED,
					ModelActions.CreativeActionTypes.MODEL_DeleteFailed
				),
				tap(
	...
	readonly showSuccessAlert$ = createEffect(
		() => {
			return this.actions$.pipe(
				ofType(
					ModelActions.CreativeActionTypes.MODEL_RestoreSuccess,
					ModelActions.CreativeActionTypes.MODEL_UpdateSuccess,
					ModelActions.CreativeActionTypes.MODEL_UpdateStatusSuccess,
					ModelActions.CreativeActionTypes.MODEL_CreateSuccess,
					ModelActions.CreativeActionTypes.COLLECTION_LOADED_SUCCESS,
					ModelActions.CreativeActionTypes.MODEL_DeleteSuccess
				),
				tap(
