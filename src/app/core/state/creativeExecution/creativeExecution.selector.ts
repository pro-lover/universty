...
import { PageQuery } from './creativeExecution.actions';
import * as fromModel from './creativeExecution.reducer';
import { State } from "./creativeExecution.state";



export const selectCollectionState = createFeatureSelector<State>("creativeExecutions");
