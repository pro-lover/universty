...
import { CreativeExecutionAddEditPage, CreativeExecutionListPage } from './';


@NgModule({
	declarations: [
		CreativeExecutionListPage,
		CreativeExecutionAddEditPage
	],
	imports: [
...
export class AdminCreativeExecutionsModule {}
