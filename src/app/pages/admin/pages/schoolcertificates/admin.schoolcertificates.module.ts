...
import { SchoolCertificateStateModule } from '@core/state/schoolCertificate/schoolCertificate-state.module';
...
import { SchoolCertificateAddEditPage, SchoolCertificateListPage } from '.';
...
@NgModule({
	declarations: [
		SchoolCertificateListPage,
		SchoolCertificateAddEditPage,
...
export class AdminSchoolCertificatesModule {}
