...
import { Account, SchoolCertificate,Brand,Client } from '@app/core/models';
...
export interface DialogData {
	selectedSchoolCertificateId: string;
  }
...
export class SchoolCertificateListPage implements OnInit, OnDestroy {
	...
	public dataView$!: Observable<SchoolCertificate[]>;
	...
	constructor(
		...
		this.dataView$ = this.store.select(SchoolCertificateSelectors.selectCollection);
	}
		...
		this.dataView$
			...
			.subscribe(
				(data:SchoolCertificate[]) =>  {
					...
					console.warn('this.dataViewschoolCertificate$', data);
	...
	private uiStateInfo() {
		...
		.pipe(
			ofType(
				SchoolCertificateActions.SchoolCertificateActionTypes.MODEL_UpdateStatusSuccess,
				SchoolCertificateActions.SchoolCertificateActionTypes.MODEL_DeleteSuccess,
				SchoolCertificateActions.SchoolCertificateActionTypes.MODEL_RestoreSuccess,
		...
		.pipe(
			ofType(
				SchoolCertificateActions.SchoolCertificateActionTypes.MODEL_UpdateStatusFailed,
				SchoolCertificateActions.SchoolCertificateActionTypes.MODEL_DeleteFailed,
				SchoolCertificateActions.SchoolCertificateActionTypes.MODEL_RestoreFailed,
	...
	private initialise( data:SchoolCertificate[]):void {
	...
	private updateStatus( id: string, params: any ):void {
		...
		this.store.dispatch(
			new SchoolCertificateActions.MODEL_UpdateStatusInitiated({
				dataId: id,
				params: params
			})
		);
	...
	public briefProgressModel(event:any,id: string): void {
		...
		confirmDialog.afterClosed().subscribe(result => {
			...
			if (result === true) {
				...
				this.store.dispatch(new SchoolCertificateActions.MODEL_DeleteInitiated({ dataId: id }) );
	...
	public restoreModel(id: string): void {
		...
		confirmDialog.afterClosed().subscribe(result => {
			...
			if (result === true) {
				...
				this.store.dispatch(new SchoolCertificateActions.MODEL_RestoreInitiated({ dataId: id }) );
	...
	public export(): void {
		...
		/* save to file */
		XLSX.writeFile(wb, 'TBWA_Africa_Conference_All_SchoolCertificates.xlsx');
